...
//          the next (non-overlapping) occurrence of "*/" should be ignored. (Here, occurrences happen in reading order:
//          line by line from left to right.) To be clear,
...
public class Lc722RemoveComments {
    public static void main(String[] args) {
        ...
        source = new String[]{"a/*comment//", "line", "more_comment*/b//hk"};
        System.out.println(removeComments(source));

        source = new String[]{"/*comment//", "line", "more_comment*/b//hk"};
        System.out.println(removeComments(source));
    }
    ...
    public static List<String> removeComments(String[] source) {
        ...
        for(String src  : source){
            ...
            for(int i =0; i < src.length(); i++){
                if(!foundBlockComment && src.charAt(i) == '/' && i + 1 < src.length() && src.charAt(i+1) == '/')
                    break;
                else if(!foundBlockComment && src.charAt(i) == '/' && i + 1 < src.length() && src.charAt(i+1) == '*'){
                    i++;
            ...
            if(!foundBlockComment && sb.length() != 0){

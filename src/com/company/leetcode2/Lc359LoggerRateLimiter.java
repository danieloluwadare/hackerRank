 ...
 * Each unique message should only be printed at most every 10 seconds (i.e. a message printed at timestamp t will prevent other
...
public class Lc359LoggerRateLimiter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(logger.shouldPrintMessage(11, "foo")); // 11 >= 11, return true, next allowed timestamp for "foo" is
    }
    ...
    static class Logger {
        ...
        public boolean shouldPrintMessage(int timestamp, String message) {
            if(!map.containsKey(message)){
                ...
                int difference = timestamp - map.get(message);
                if(difference >= 10){
                    map.put(message,timestamp);
                    return true;
                }
